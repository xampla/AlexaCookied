...
def getBasicInformation():
    ...
    print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "Username: " + auth["customerName"])
    print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "User email: " + auth["customerEmail"])
    print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "Has Prime Music: " + str(auth["canAccessPrimeMusicContent"]))
    print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "User ID: " + auth["customerId"])
    print("---------------------------------------------------------------------------")
...
def getLists():
    ...
    for list in data['lists']:
        print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "Name: " + str(list['name']))
...
def extractHoseholdInfo():
    ...
    for usr in data['accounts']:
        print("[" + "\033[92m" + "*" + "\033[00m" + "] " + "Name: " + usr['fullName'] + " Email " + usr['email'] + " Role: " + usr['role'])
    print("---------------------------------------------------------------------------")
